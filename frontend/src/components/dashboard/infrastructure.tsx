        ...
        <div className="flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            <span className="flex items-center gap-1 font-mono text-[10px] 2xl:text-xs text-emerald-600">
              ...
              {assetCount} Target{assetCount > 1 ? 's' : ''}
            </span>
            <button
              onClick={() => setIsAddAssetOpen(true)}
              className="rounded-md bg-slate-100 hover:bg-brand hover:text-white px-1.5 py-0.5 font-mono text-[10px] text-slate-700 font-semibold transition-colors"
              title="Register New Target Host"
            >
              + Add
            </button>
          </div>
